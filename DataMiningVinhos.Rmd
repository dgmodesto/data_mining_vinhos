...
cor(train$quality,train$totalsulfurdioxide)
cor(train$quality,train$freesulfurdioxide)
cor(train$quality,train$residualsugar)
cor(train$quality,train$citricacid)
cor(train$quality,train$alcohol)
cor(train$quality,train$id_vinho)
cor(train$quality,train$pH)
cor(train$quality,train$density)
cor(train$quality,train$sulphates)
cor(train$quality,train$fixedacidity)
cor(train$quality,train$chlorides)
cor(train$quality,train$volatileacidity)
cor(train$quality,train$Vinho)
```
